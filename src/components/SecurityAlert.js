...
export function checkForLog(diagram, setAlertMessage) {
  if (diagram.model.nodeDataArray.length > 0) {
    ...
    const message = {
      key: Date.now().toString(), // Unique key for each message
      hasQuickmessage: " QuickSight가 암호화되지 않을 시, 무단 접근 및 변조 등을 통한 보험 위험이 존재할 수 있습니다.",
      hasOpenSearch:" OpenSearch 암호화되지 않을 시, 무단 접근 및 변조 등을 통한 보험 위험이 존재할 수 있습니다.",
      hasAthena:" Athena가 암호화되지 않을 시, 무단 접근 및 변조 등을 통한 보험 위험이 존재할 수 있습니다.",
      hasS3:" S3가 암호화되지 않을 시, 무단 접근 및 변조 등을 통한 보험 위험이 존재할 수 있습니다."
