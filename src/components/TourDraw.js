...
const TourDraw = (props) => {
  ...
  const {refDownloadBtn,refPalette, refDiagram, refButton, refAlert, refPopup, refCost, setShowToggle, refLS, refSummary, refOptimize, refNetworkPalette, refCloudPalette, refSidebar, refSaveButton } = props;
  ...
  const steps = [
    {
      ...
      placement: "center",
      title: '다이어그램 공간입니다.',
      description: 'ClouMaestro의 가장 중심이 되는 부분이고, 아키텍처가 도식화되는 공간입니다.',
    ...
    },
    {
      ...
      description: '사용자가 아키텍처를 도식화할 수 있도록 네트워크 아이콘과 AWS 리소스 아이콘을 제공합니다. 팔레트에서 다이어그램으로 아이콘을 드래그하여 아키텍처를 도식화할 수 있습니다.',
    ...
    },
    {
      ...
      description: '팔레트, 다이어그램 지우기, 파일 업로드/다운로드, 이미지 다운로드, Lift&Shift, 요구사항 기반 최적화, 비용 요약 기능을 제공합니다.',
    ...
    },
    {
      ...
      description: '사용자가 네트워크 아키텍처를 구성할 수 있도록 네트워크 아이콘을 제공합니다.',
    ...
    },
    {
      ...
      description: 'CSP에서 제공하는 리소스 아이콘이 담겨 있습니다. 사용자가 클라우드 아키텍처를 구성하거나, 수정할 수 있도록 제공합니다.',
      target: () => refCloudPalette.current,
    },
    {
      id: "beforeSidebar",
      title: '',
      description: '현재 클라우드 아키텍처에 대한 파일과 이미지는 다음과 같은 버튼에서 다운로드 받을 수 있습니다.',
    ...
    },
    {
      id: "alert",
      title: "",
      description: '현재 도식화된 클라우드 아키텍처 상에 존재하는 보안 및 권고 사항을 볼 수 있는 버튼입니다.',
      target: () => refAlert.current,
    },
    {
      id: "alertList",
      title: '클라우드 아키텍처상에 존재하는 보안 결함 및 권고 사항에 대해 알려줍니다.',
      description: 'info/warning/error로 구분되어 있으며, ISO/IEC 27001, 27017, 27018과 AWS Well-Architected Framework를 기반으로 정보를 제공합니다.',
      // target: () => refDiagram.current,
    },
    {
      id: "optimize",
      placement: "right",
      title:"",
      description: '다이어그램의 클라우드 아키텍처를 고도화할 수 있게 해주는 최적화 버튼입니다.',
      target: () => refOptimize.current,
    },
    //8
    {
      id: "popup",
      title: '보안/로깅/백업/이중화/부하분산 등 사용자의 요구사항에 기반해 다양한 최적화 기능을 제공합니다.',
      description: '전체 아키텍처 혹은 망 별 아키텍처에 대한 요구사항을 선택하고, 최적화 기능을 적용할 수 있습니다.',
    ...
    },
    {
      ...
      description: 'EC2, RDS는 인스턴스 세부 타입까지 설정하여 비용을 산정할 수 있습니다.',
      target: () => refDiagram.current,
    },
    {
      id: "costToggle",
      title: '비용을 산정할 수 있는 토글입니다.',
      description: '예시로, EC2 비용산정에서는 Platform, Instance Type, Instance Size를 설정할 수 있습니다.',
    ...
    },
    {
      ...
      description: 'MyPage에서는 아키텍처의 비용 산정 요약 및 리소스 가이드라인, 보안 권고 가이드라인을 제공합니다.',
